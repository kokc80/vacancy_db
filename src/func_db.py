...
def db_connect(db_name: str):
    ...
    conn = psycopg2.connect(
        host="localhost", user="postgres", password="678330", port="5432"
    )
    ...
    try:
        ...
        try:
            cur.execute(
                f"CREATE TABLE tab_vac (vac_id varchar, vac_name varchar, vac_url varchar, "
        ...
        try:
            cur.execute(
                f"CREATE TABLE tab_emp (emp_id varchar, emp_name varchar, emp_url varchar,emp_vac_url "
